...
path.to.save.output <- file.path(outdir, 
                                 "VDJ_output", 
                                 PROJECT, 
...
#####----------------------------------------------------------------------#####
if (PROJECT == "1st_2nd_BSimons_Datasets"){
  metadata.1st <- readxl::read_excel(file.path(path.to.main.output, "metadata_1st_dataset.xlsx"))
  metadata.2nd <- readxl::read_excel(file.path(path.to.main.output, "metadata_2nd_dataset.xlsx"))
