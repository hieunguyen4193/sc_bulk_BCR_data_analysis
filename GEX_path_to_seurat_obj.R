...
path.to.all.s.obj <- list(
  `2nd_dataset` = file.path(outdir, 
                            "sc_bulk_BCR_data_analysis_v0.1/1st_2nd_BSimons_Datasets/data_analysis/01_output/2nd_dataset_removed_5_6.without_reInt.res1/2nd_dataset_removed_5_6.without_reInt.res1.rds"),
  `1st_dataset` = file.path(outdir, "sc_bulk_BCR_data_analysis_v0.1/1st_2nd_BSimons_Datasets/data_analysis/01_output/1st_dataset_removed_7_9_removed_16_removed_9.with_reInt.res1/1st_dataset_removed_7_9_removed_16_removed_9.with_reInt.res1.rds"),
  ...
  `241002_241104_BSimons` = file.path(outdir, "sc_bulk_BCR_data_analysis_v0.1/241002_241104_BSimons/data_analysis/01_output/s8_output/241002_241104_BSimons.output.s8.rds")
)
