...
for (mouse.id in c("m3", "m7")){
  ...
  group.to.highlight1 <- subset(meta.data.splitted, meta.data.splitted$mouse == mouse.id & organ %in% c("PP"))$SampleID
  group.to.highlight2 <- subset(meta.data.splitted, meta.data.splitted$mouse == mouse.id & organ %in% c("PP") == FALSE)$SampleID
