...
```{r echo=FALSE, warning=FALSE, results='asis', message=FALSE, fig.width=14, fig.height=10}
DimPlot(object = with.mutation.rate.s.obj, cells.highlight = high.mutation.rate.cells) + DimPlot(object = with.mutation.rate.s.obj, cells.highlight = low.mutation.rate.cells)
```
