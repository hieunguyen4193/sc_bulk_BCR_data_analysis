...
writexl::write_xlsx(metadata.1st, file.path(path.to.main.output, "metadata_1st_dataset.xlsx"))
writexl::write_xlsx(metadata.2nd, file.path(path.to.main.output, "metadata_2nd_dataset.xlsx"))